...
export class Message extends Model {
    ...
    getViewElement(me = true) {
        ...
        switch (this.type) {
            case "contact":
                console.log("content do contato:", this.content);
                div.innerHTML = `
            ...
            case "image":
                            ...
                            <div>
                                <div class="_3v3PK" style="width: 330px; height: 330px;">
                                    <div class="_34Olu">
                                        <div class="_2BzIU">
                                            <div class="_2X3l6">
                                                <svg class="_1UDDE audio-play" width="50" height="50" viewBox="0 0 43 43">
                ...
                let imgEl = div.querySelector(".message-photo");
                        ...
                        <div class="_1fnMt _2CORf">
                            <a class="_1vKRe" href="#">
                                ...
                                <div class="_12xX7">
                                    ...
                                    <div class="nxILt">
                                        <span dir="auto" class="message-filename">${this.filename || "Carregando.."}</span>
                                    </div>
                                    <div class="_17viz">
            ...
            case "audio":
                ...
                let btnPause = div.querySelector(".audio-play");
    ...
    static sendImage(chatId, from, file) {
        return new Promise((s, f) => {
            Message.upload(file, from).then((snapshot) => {
                // Forma nova do Firebase Storage
                snapshot.ref.getDownloadURL().then((downloadURL) => {
